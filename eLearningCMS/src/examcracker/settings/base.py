...
EMAIL_HOST_PASSWORD = 'examcracker@2020'
EMAIL_USE_TLS = True
...
MEDIA_SERVER_IP = '143.110.240.158'
...
MEDIA_SERVER_APP_ABR = 'gyaanhiveABR'
MEDIA_SERVER_SUB_DOMAIN_ABR = 'www.live3.gyaanhive.com'
MEDIA_SERVER_IP_ABR = '139.59.17.20'
